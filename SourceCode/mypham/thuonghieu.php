    ...
    <div class="full_home">
        ...
        <div id="banner">
            ...
            <div class="NEW-content">
                    <?php 
                        $sql_pro = "SELECT * FROM tbl_sanpham WHERE id_thuonghieu='$_GET[id]' ORDER BY id_sanpham DESC LIMIT 12 ";
                        $query_pro = mysqli_query($mysqli,$sql_pro);

                        $sql_cate = "SELECT * FROM tbl_thuonghieu WHERE id_thuonghieu='$_GET[id]' LIMIT 1";
                        $query_cate = mysqli_query($mysqli,$sql_cate);
                        $row_title = mysqli_fetch_array($query_cate);
                        
                    ?>
                        <h2>Thương hiệu: <?php echo $row_title['tenthuonghieu'] ?> </h2>
                    <?php
